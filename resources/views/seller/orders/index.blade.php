                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-dark-100 bg-dark-50/50">
                            ...
                            <th class="text-center text-xs font-semibold text-dark-600 uppercase tracking-wider px-6 py-4">Detail</th>
                            <th class="text-center text-xs font-semibold text-dark-600 uppercase tracking-wider px-6 py-4">Ubah Status</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-dark-50">
                        @foreach ($orderItems as $item)
                            <tr class="hover:bg-dark-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('seller.orders.show', $item->order) }}" class="inline-flex items-center gap-1 text-xs text-primary-600 hover:text-primary-700 font-medium">
